...
- **Graph-Based Construction**: Declare DAG workflows with explicit edges (`flow.Edge(fetchUser, processPayment)`), catch cycles at startup, and export diagrams with `plan.ToMermaid()`.
